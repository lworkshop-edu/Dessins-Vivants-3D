...
namespace SpriteAssist
{
    ...
    {
        private const float DETAIL = 0.8f;
        private const byte ALPHA_TOLERANCE = 0;
        private const float EDGE_SMOOTHING = 1;
        private const bool DETECT_HOLES = true;
        private const float PIXELS_PER_UNIT = 100;
        private const float OPAQUE_EXTRUDE = 0f;
        ...
        public Mode mode = Mode.OpaqueMesh;
