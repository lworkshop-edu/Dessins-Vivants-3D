...
namespace FastShadowReceiver {
	public class TerrainMeshTree : MeshTreeBase {
		...
		{
			m_heightMapWidth = m_terrainData.heightmapResolution - 1;
			m_heightMap = m_terrainData.GetHeights(0, 0, m_terrainData.heightmapResolution, m_terrainData.heightmapResolution);
